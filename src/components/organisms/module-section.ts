  ...
  connectedCallback() {
    ...
    this.innerHTML = `
      <style>
        ...
        .info-button { font-size: 1rem; }
        .toggle-button { font-size: 1.2rem; }
      ...
      <div class="module">
        <div class="module-header">
          ...
          <div class="module-header-controls">
            <button class="info-button" popovertarget="${id}-instructions" aria-label="Show instructions" title="Show instructions">
              <span>?</span>
            </button>
            <button class="toggle-button" aria-label="Toggle module" aria-expanded="${this.isExpanded}" title="${this.isExpanded ? 'Collapse module' : 'Expand module'}">
